...
static SETTINGS: &[Setting] = &[
    ...
    toggle("overcall_discipline", COMPETITION, "", true, american::set_overcall_discipline),
    ...
    toggle("uvu_over_majors", COMPETITION, "", true, american::set_uvu_over_majors),
    ...
    toggle("strong_two_competition", COMPETITION, "", true, american::set_strong_two_competition),
    ...
    toggle("competitive_rebid", FLOOR, "", true, instinct::set_competitive_rebid),
    toggle("rubens_advances", FLOOR, "", true, instinct::set_rubens_advances),
    toggle("floor_rkcb", FLOOR, "", true, instinct::set_floor_rkcb),
    toggle("suppress_nt_game_force_over_double", FLOOR, "", true, instinct::set_suppress_nt_game_force_over_double),
    toggle("correct_3nt_to_major", FLOOR, "", true, instinct::set_correct_3nt_to_major),
