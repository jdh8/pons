...
/// `(3♣) X -`: the defensive book has no 3♣ entry, but the floor still
...
/// `(1♣) 1♠ -`: a limit raise of spades goes through the transfer into their
...
/// `(1♠) 2♣ -`: a two-level overcall has no room for the ladder, so the cue
