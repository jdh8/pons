...
* ~~The flip arm~~ — built and **measured 2026-09-18/19, a non-win**; verdict
  above.  Both knobs stay off.
* **The third arm** — the `Pass` rails at the three phantom families above,
  sized by the sit counterfactual at +0.0075 / +0.0055 NV and +0.0029 /
  −0.0005 both-vul; not built, awaiting the user.
