...
### N1r — idea queue for `1NT (2♣) 3♦`+ (**collected 2026-09-21; step 0 — `3NT` vs the values `X` by colour — SHIPPED DEFAULT-ON 2026-09-22 at favourable; the queue itself unbuilt**)
...
**Owed, low priority:** D's short-major split (`min major ≥ 3` wins, `≤ 2`
loses) re-sliced on the `ew` dumps — if the `≤ 2` half loses at favourable
too, the narrowed gate is a second increment on the same cell.
