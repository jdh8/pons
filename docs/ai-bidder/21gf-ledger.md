...
| — | **Direct weak jump overcall** | candidate, default OFF | BEN Phase-1 shared residual: exactly-six-card weak major jumps `1M`→`2M` | Attribution gate passes both references: BEN 1,348 boards **−1.102 ±0.345 plain / −0.976 ±0.416 PD**; BBA 4,895 **−2.454 ±0.194 / −2.785 ±0.228**. Every hand 6–11 HCP; >98% exactly six. Authored with exact disclosure and the natural-preempt continuation; fresh 204.8k/arm/vul BBA A/B pending (`direct_weak_jump_overcall`, `scripts/ab-direct-weak-jump-overcall.sh`). | pending |
