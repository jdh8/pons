...
| — | **Direct weak jump overcall** | **shipped, default ON** | BEN Phase-1 shared residual: exactly-six-card weak major jumps `1M`→`2M` | Attribution gate passes both references: BEN 1,348 boards **−1.102 ±0.345 plain / −0.976 ±0.416 PD**; BBA 4,895 **−2.454 ±0.194 / −2.785 ±0.228**. Fresh seed `1786431801`, 204.8k/arm/vul BBA: plain +0.0002/+0.0031, PD +0.0026/+0.0051, SD-PD +0.0032/+0.0057 none/both — pass. Same-seed 12.8k/vul Tier-F: plain +0.0098 ±0.0099 / +0.0013 ±0.0128, PD +0.0101 ±0.0120 / −0.0020 ±0.0154, SD-PD +0.0058 ±0.0120 / −0.0087 ±0.0147 — wash, no refutation. Exact post-ship anchor moves pooled +0.010/+0.006 plain/PD and def-r1 +10,282/+11,418 IMPs. Ships by the two-reference rule; `false`/`--no-*` restores simple `1M`. | `782f09e` |
