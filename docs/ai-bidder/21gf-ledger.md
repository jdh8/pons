...
| — | **Direct weak jump overcall** | candidate, default OFF; BBA passes, BEN gate next | BEN Phase-1 shared residual: exactly-six-card weak major jumps `1M`→`2M` | Attribution gate passes both references: BEN 1,348 boards **−1.102 ±0.345 plain / −0.976 ±0.416 PD**; BBA 4,895 **−2.454 ±0.194 / −2.785 ±0.228**. Every hand 6–11 HCP; >98% exactly six. Fresh seed `1786431801`, 204.8k/arm/vul BBA: plain +0.0002 ±0.0028 / +0.0031 ±0.0035, PD +0.0026 ±0.0032 / +0.0051 ±0.0040, SD-PD +0.0032 ±0.0033 / +0.0057 ±0.0040 none/both — pass, no SD refutation. Same-seed 25.6k Tier-F gate next. | pending |
