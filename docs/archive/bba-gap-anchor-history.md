# The BBA gap campaign — anchor history (archived 2026-08-18)

> **Archived (2026-08-18).** This is `docs/bba-gap-campaign.md` as it stood at
> `1ed0f58d`, minus the closed floor forensic (now
> [bba-gap-floor-forensic.md](bba-gap-floor-forensic.md)). The live doc —
> [../bba-gap-campaign.md](../bba-gap-campaign.md) — keeps the protocol, the
> rules this history taught, the runbook, the current ranking and the headline
> trail as a table; **its header, protocol and runbook supersede the ones
> below**. What is archived here is the chronological narrative: every
> re-anchor paragraph, the per-treatment sagas (each also recorded in
> [../bidding-options.md](../bidding-options.md) and the CHANGELOG), the
> retractions and corrections, and the 2026-07-07 pillar plan as it stood —
> Pillar A shipped; B1 (learned-floor round 3) never ran and was superseded by
> B4, itself superseded by the configured net
> ([../ai-bidder/configured-net.md](../ai-bidder/configured-net.md)); B2's
> still-open floor items moved to the live doc's *Open work*; B3 settled; C was
> built and its "plain sd-win ships" rule retired
> ([../measurement.md](../measurement.md) §"Plain SD is not an arbiter"); D is a
> pointer to [../ai-bidder/21gf-ledger.md](../ai-bidder/21gf-ledger.md).
> Nothing here is maintained; read it for *why* a rule exists.
...
The [2026-08-18 forensic](bba-gap-floor-forensic.md) found 21 of
...
forensic](bba-gap-floor-forensic.md) and are reading repairs
