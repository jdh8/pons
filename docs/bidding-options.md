...
| direct_weak_jump_overcall | `--ns-direct-weak-jump-overcall`; `scripts/ab-direct-weak-jump-overcall.sh` | Natural (range-disclosed) | OFF | Phase-1 shared residual: pons `1M` vs reference `2M`, BEN 1,348 boards −1.102 ±0.345 plain / −0.976 ±0.416 PD, BBA 4,895 −2.454 ±0.194 / −2.785 ±0.228; >98% exactly six-card, all 6–11 HCP. Candidate bids weak 2M on exactly six, 8+ points, ≤11 HCP; five-card/12+/seven-card paths unchanged | fresh BBA 204.8k/arm/vul pending | opt-in candidate, default byte-identical |
