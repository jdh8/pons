...
| set_meckstroth_adjunct | `meckstroth-abc` (no bba-gen flag) | Artificial | ON | plain wash (−0.001/+0.001), PD −0.0036/−0.0019 (over-punished), **sd-lead +0.0012/+0.0042** (2 seeds ×200k, SHA 22364c9; vul CI-clean +1.5–2.4/div, NV weakly +); sd redeems the PD loss — vindicates 21gf-ledger "keep". Repro: `ab-meckstroth --sd` | fresh | keep default-on ✓ |
