...
pub use bidding::{
    ...
    System, Table, Trie, Versus, american, american_book, american_configured,
    american_configured_with, american_floor, american_instinct, dutch, dutch_instinct, instinct,
};
#[cfg(feature = "dd")]
