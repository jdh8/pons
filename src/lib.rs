...
pub use bidding::{
    ...
    System, Table, Trie, Versus, american, american_book, american_floor, american_instinct,
    american_with_card, american_with_config, dutch, dutch_book, dutch_instinct, dutch_with_config,
    instinct,
};
#[cfg(feature = "dd")]
