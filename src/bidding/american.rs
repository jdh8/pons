...
pub use defense::{
    ...
    set_landy, set_landy_hcp, set_leaping_michaels, set_longest_first_advance, set_meckwell,
    ...
    set_notrump_balancing, set_notrump_defense, set_nt_overcall_gladiator,
    set_nt_overcall_no_major, set_nt_overcall_systems_on, set_overcall_discipline,
    ...
    set_takeout_support, set_transfer_defense, set_two_level_minor_overcall_tight,
