...
pub use competition::{
    ...
    set_free_bid_quality, set_free_bids, set_high_overcall_responses, set_jordan_truscott,
    set_lebensohl, set_lebensohl_style, set_major_support_double, set_natural_floor,
    set_negative_double_shape, set_penalty_double_leave_in, set_penalty_pass, set_splinter_doubled,
...
pub use rebids::{
    set_balanced_1nt_rebid, set_fourth_suit_forcing, set_major_rebid_tails, set_meckstroth_adjunct,
