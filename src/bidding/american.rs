...
pub use defense::{
    ...
    set_direct_dont_one_suiter_min, set_direct_landy_double, set_doubled_landy_escape, set_landy,
    set_landy_hcp, set_leaping_michaels, set_natural_defense, set_natural_double_floor,
    set_natural_double_shape, set_natural_double_weight, set_natural_overcall_points,
    set_notrump_balancing, set_passed_hand_defense, set_responsive_overcall,
