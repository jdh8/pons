...
//! the raises, the natural bids and their floor ([`set_natural_floor`]), the
...
//!
//! Roughly a third of this file is [`over_their_overcall_legacy`], the retired
...
use super::penalty_double::trap_pass;
...
#[cfg(test)]
pub(super) fn over_their_overcall_legacy(opening: Suit) -> Rules {
    let o = opening;
    let o_strain = Strain::from(o);
