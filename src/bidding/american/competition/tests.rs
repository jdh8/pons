...
fn per_overcall_tables_match_legacy() {
    ...
    use super::free_bids::set_free_bid_quality;
    use super::free_bids::set_free_bid_style;
    use super::free_bids::set_free_bids;
    use super::negative_double::NegativeDoubleShape;
    use super::negative_double::set_negative_double_shape;
    use super::over_overcall::over_their_overcall;
    use super::over_overcall::over_their_overcall_legacy;
