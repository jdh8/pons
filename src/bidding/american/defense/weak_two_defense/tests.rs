use super::super::tests::{best_call, best_call_vul, call};
...
fn advance_game_threshold_tracks_the_notrump_band() {
    ...
    super::weak_two_defense::set_weak_two_notrump_advances(true);
    ...
    super::weak_two_defense::set_weak_two_notrump_advances(false);
