#!/bin/sh
# ab-a4.sh — measurements for the A4 pass of the bidding-options audit
...
# (unlike ab-a3.sh, whose knobs had no flag and drove self-play directly).
#
...
#
#   JOBS=24 BOARDS=153600 setsid nohup scripts/idle-run.sh scripts/ab-a4.sh ab-results/a4 \
...
R=${1:?usage: ab-a4.sh RESULTS_DIR}
. "$(dirname "$0")/ab-lib.sh"
