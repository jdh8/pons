#!/bin/sh
# disclose-ab.sh — what does it cost us when BBA is told what we play?
#
...
#
#   setsid nohup scripts/idle-run.sh scripts/disclose-ab.sh \
...
R=${1:?usage: disclose-ab.sh RESULTS_DIR}
