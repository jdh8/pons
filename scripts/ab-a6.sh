#!/bin/sh
# ab-a6.sh — measurements for the A6 pass of the bidding-options audit
...
#
#   JOBS=12 setsid nohup scripts/idle-run.sh scripts/ab-a6.sh ab-results/a6 \
...
R=${1:?usage: ab-a6.sh RESULTS_DIR}
