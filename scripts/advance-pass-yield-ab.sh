#!/bin/sh
# advance-pass-yield-ab.sh — price the weak advancer's pass-yield to a 4-card
...
# scripts/rich-advance-ab.sh; do NOT touch the codebase while it runs.
#
#   setsid nohup scripts/idle-run.sh \
#       scripts/advance-pass-yield-ab.sh ab-results/advance-pass-yield \
...
R=${1:?usage: advance-pass-yield-ab.sh RESULTS_DIR}
