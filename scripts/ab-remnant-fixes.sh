#!/bin/sh
# ab-remnant-fixes.sh — fix-vs-shipped A/Bs for the point-count remnant
...
#   setsid nohup scripts/idle-run.sh scripts/ab-remnant-fixes.sh \
...
set -eu
R=${1:?usage: ab-remnant-fixes.sh RESULTS_DIR}
