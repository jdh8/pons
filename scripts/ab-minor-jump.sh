...
# Modeled on scripts/ab-rich-advance.sh; do NOT touch the codebase while it runs.
#
#   BOARDS=409600 setsid nohup scripts/idle-run.sh \
#       scripts/ab-minor-jump.sh ab-results/minor-jump \
...
R=${1:?usage: ab-minor-jump.sh RESULTS_DIR}
