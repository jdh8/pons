#!/bin/sh
# ab-a3.sh — measurements for the A3 pass of the bidding-options audit
...
#
#   setsid nohup scripts/idle-run.sh scripts/ab-a3.sh ab-results/a3 \
...
set -eu
cd "$(dirname "$0")/.."
R=${1:?usage: ab-a3.sh RESULTS_DIR}
mkdir -p "$R"
