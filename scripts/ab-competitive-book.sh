#!/bin/sh
# ab-competitive-book.sh — the chained A/B campaign for the competitive-book
...
#
#   setsid nohup scripts/idle-run.sh scripts/ab-competitive-book.sh \
...
R=${1:?usage: ab-competitive-book.sh RESULTS_DIR}
SHOW=3
. "$(dirname "$0")/ab-lib.sh"
