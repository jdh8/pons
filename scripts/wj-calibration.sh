...
# NOT bound the campaign: the WJ net's job is to be *in distribution* for a
# wide-1♣ minor structure like WJ's own, and a teacher of equal strength that
# speaks the right language is exactly what is wanted.  This is a negative
# check — that the structure is not a systemic liability — plus a
# competent-WJ reference dump.
