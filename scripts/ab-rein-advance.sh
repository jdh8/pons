#!/bin/sh
# ab-rein-advance.sh — measure reining in a minimum takeout doubler that
...
#
#   setsid nohup scripts/idle-run.sh scripts/ab-rein-advance.sh \
...
# while this runs.
R=${1:?usage: ab-rein-advance.sh RESULTS_DIR}
SHOW=3
