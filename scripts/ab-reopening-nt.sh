#!/bin/sh
# ab-reopening-nt.sh — measure opener's authored balanced-18-19 notrump actions
...
#
#   setsid nohup scripts/idle-run.sh scripts/ab-reopening-nt.sh \
...
# while this runs.
R=${1:?usage: ab-reopening-nt.sh RESULTS_DIR}
SHOW=3
