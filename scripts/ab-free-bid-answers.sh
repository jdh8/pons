#!/bin/sh
# ab-free-bid-answers.sh — Fix-1 v2: complete the free-bid convention. The
...
#
#   setsid nohup scripts/idle-run.sh scripts/ab-free-bid-answers.sh \
...
R=${1:?usage: ab-free-bid-answers.sh RESULTS_DIR}
SHOW=3
. "$(dirname "$0")/ab-lib.sh"
